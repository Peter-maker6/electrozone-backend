    ...
    with app.app_context():
        ...
        products = [
            ...
            Product(
                ...
                description='Samsung Galaxy Z Fold 5 with 7.6"折叠屏, Snapdragon 8 Gen 2, 512GB storage. Transform your phone into a tablet for ultimate productivity and entertainment.',
                price=199999.00,
